...
export default function NavLink({
    ...
    return (
        <Link
            ...
            className={
                active
                    ? `${className} inline-flex items-center px-1 my-2 rounded-md text-sm font-medium leading-5 text-gray-900 py-2 focus:outline-none bg-blue-700 text-white dark:bg-gray-800 transition duration-150 ease-in-out `
